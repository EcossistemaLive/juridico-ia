/**
 * Gera `src/skills/base-juridica/conteudo.js` a partir do material de referência.
 *
 * Por que gerar em vez de ler o .md em runtime: as rotas rodam em função
 * serverless no Netlify, onde o bundle não carrega arquivos soltos com
 * confiabilidade. O conteúdo vira um módulo JS, entra no bundle e é servido
...
const FONTE = path.join(RAIZ, "referencias", "advogado-especialista", "SKILL.md");
const DESTINO = path.join(RAIZ, "src", "skills", "base-juridica", "conteudo.js");
